...
export function NewPostCard({ post, featured = false }: NewPostCardProps) {
...
export function NewFeaturedPostCard({ post }: { post: Post }) {
  return <NewPostCard post={post} featured />
}
