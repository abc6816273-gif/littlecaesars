    ...
    <div className="mx-auto max-w-6xl px-3 sm:px-6 lg:px-8">
      ...
      <div className="lg:hidden mb-4">
        <button
          ...
          className="flex items-center justify-between w-full p-3 bg-sand/10 rounded-lg border border-stone/10 text-stone font-medium touch-manipulation hover:bg-sand/20 transition-colors duration-200"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6 lg:gap-8">
        {/* Sidebar */}
        <aside 
          className={`order-2 lg:order-1 transition-all duration-300 ease-in-out ${sidebarOpen ? 'block' : 'hidden lg:block'}`}
          id="mobile-sidebar"
        >
