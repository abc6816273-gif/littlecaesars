...
const internalLinks = {
    main: [
        ...
        { href: '/little-caesars-coupons-january-2026', label: 'Coupons & Deals 2026', icon: Tag, desc: '15+ verified codes' },
    ],
    popular: [
        { href: '/little-caesars-pretzel-crust-pizza-2026', label: 'Pretzel Crust Pizza 2026', icon: Flame, desc: 'Limited time - $9.99' },
        ...
        { href: '/little-caesars-new-items-2026', label: 'New Items 2026', icon: TrendingUp, desc: '10 new menu items' },
    ],
    guides: [
...
export function RelatedPosts({ currentSlug = '' }: { currentSlug?: string }) {
    const posts = [
        { slug: 'pretzel-crust-pizza-2026', title: 'Pretzel Crust Pizza 2026', href: '/little-caesars-pretzel-crust-pizza-2026' },
        ...
        { slug: 'new-items-2026', title: 'New Items 2026', href: '/little-caesars-new-items-2026' },
        { slug: 'coupons', title: 'Coupons & Deals 2026', href: '/little-caesars-coupons-january-2026' },
