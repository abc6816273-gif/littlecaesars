      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
        <article className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-8 sm:mb-10 lg:mb-12">
            ...
            <div className="w-16 sm:w-20 lg:w-24 h-1 bg-texas-yellow mx-auto rounded-full mb-4 sm:mb-6"></div>
          </header>
          ...
          <div className="bg-stone-50 rounded-lg sm:rounded-xl p-4 sm:p-6 lg:p-8 mb-8 sm:mb-10 lg:mb-12">
            ...
            <div className="text-center mt-6 sm:mt-8">
              <a 
                ...
                className="inline-flex items-center justify-center bg-texas-yellow text-texas-black px-6 py-3 rounded-lg font-semibold hover:bg-texas-yellow/90 transition-colors text-sm sm:text-base w-full sm:w-auto"
              >
          ...
          <div className="bg-texas-yellow/10 border border-texas-yellow/20 rounded-lg sm:rounded-xl p-4 sm:p-6 lg:p-8 mb-8 sm:mb-10 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-stone-900 mb-6 sm:mb-8 text-center">
          ...
          <div className="text-center">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center bg-texas-yellow text-texas-black px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold text-base sm:text-lg hover:bg-texas-yellow/90 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 w-full sm:w-auto"
            >
