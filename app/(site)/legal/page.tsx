...
export const metadata: Metadata = {
  title: 'Legal Information & Disclaimers | Little Caesars Menu',
  description: 'Complete legal disclaimers, terms of use, and copyright information for Little Caesars Menu. Independent informational website with official disclaimers.',
  keywords: ['legal information', 'disclaimers', 'terms of use', 'copyright', 'Little Caesars Menu', 'independent website'],
  alternates: {
    canonical: '/legal',
  },
  robots: {
  ...
  openGraph: {
    title: 'Legal Information | Little Caesars Menu',
    description: 'Legal disclaimers and terms of use for Little Caesars Menu - an independent informational website.',
    type: 'website',
    url: '/legal',
  },
}
...
export default function LegalPage() {
  ...
  const structuredData = {
    ...
    description: 'Legal disclaimers, terms of use, and copyright information for Little Caesars Menu website',
    ...
    mainContentOfPage: {
      '@type': 'WebPageElement',
      text: 'Legal disclaimers and terms of use for independent Little Caesars menu information website',
    },
  }
          ...
          <div className="space-y-8 text-left">
            <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-8">
              ...
              <p className="text-red-700 mb-0">
                <strong>This website is NOT affiliated with Little Caesars.</strong> 
                We are an independent informational site. Little Caesars Menu is not endorsed by, 
                sponsored by, or associated with Little Caesars or any of its subsidiaries, 
            ...
            <section className="space-y-4">
              ...
              <p className="text-stone/80 leading-relaxed">
                "Little Caesars" is a registered trademark of Little Caesars Enterprises, Inc. 
            ...
            <section className="space-y-4">
              ...
              <p className="text-stone/80 leading-relaxed">
                ...
                endorsed by, or connected to Little Caesars in any way. Any references to Little Caesars 
            ...
            <p>
              In no event shall Little Caesars Menu, its operators, or contributors be liable for any 
            ...
            <div className="bg-green/10 border border-green/20 rounded-lg p-6 mt-8">
              <h3 className="font-slab font-slab-bold text-lg text-stone mb-3 mt-0">
                Looking for Official Little Caesars Information?
              </h3>
              <p className="mb-4">
                For official restaurant information, locations, hours, reservations, and customer service, 
                please visit the official Little Caesars website.
              </p>
              <a
