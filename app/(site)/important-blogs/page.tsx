...
const featuredBlogs = [
  {
    ...
    title: 'Little Caesars Calorie Calculator 2026 - Count Calories for Your Order',
  ...
  },
  {
    id: 'lc-vs-dominos',
    category: 'Comparison',
    title: 'Little Caesars vs Dominos 2026 - Ultimate Pizza Price Comparison',
  ...
  },
  {
    id: 'lc-vs-pizza-hut',
    category: 'Comparison',
    title: 'Little Caesars vs Pizza Hut 2026 - Price & Quality Showdown',
  ...
  {
    id: 'coupons-january-2026',
    category: 'Coupons & Deals',
    title: 'Little Caesars Coupons January 2026 - 50% Off Promo Codes & Deals',
    excerpt: 'Get 15 verified Little Caesars coupons for January 2026! Exclusive promo codes: 50% off, FREE Crazy Bread, $5.99 pizzas, BOGO deals. Save up to $20 on your next order!',
    image: '/menu/Homepage-menus/ExtraMostBestest-Pepperoni-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Coupons January 2026 - Save 50% with Promo Codes',
    date: 'January 1, 2026',
    readTime: '5 min read',
  ...
  },
  {
    ...
    category: 'Trending',
    title: 'Crazy Puffs Little Caesars 2026 - Complete Guide, Flavors, Price & Calories',
    excerpt: 'Everything you need to know about Little Caesars viral Crazy Puffs! All 5 flavors, prices starting at $3.99, calories, nutrition facts, and honest reviews. The #1 trending menu item of 2024-2026!',
  ...
  },
  {
    id: 'new-items-2026',
    category: 'New Menu',
    title: 'Little Caesars New Items 2026 - Complete Guide to All New Menu Items',
    excerpt: 'Discover all 10 NEW Little Caesars menu items for 2026! Stuffed Crust, Pretzel Crust, new pizzas, sides, drinks, and exclusive deals. Everything launching this year with prices and availability.',
    image: '/menu/Homepage-menus/Stuffed-Crust-Pepperoni-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars New Menu Items 2026 - All New Pizzas, Sides, and Deals',
    date: 'December 26, 2026',
  ...
  },
  {
    ...
    title: 'Little Caesars Nutrition & Calories Guide 2026 - Complete Health Facts',
    ...
    image: '/menu/Homepage-menus/ExtraMostBestest-Pepperoni-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Nutrition Facts and Calorie Guide 2026',
    date: 'December 26, 2026',
    readTime: '8 min read',
  ...
  {
    id: 'happy-christmas-2026',
    category: 'Holiday Special',
    title: 'Happy Christmas 2026 - Little Caesars Holiday Deals & Festive Pizza Guide',
    excerpt: 'Celebrate Christmas 2026 with Little Caesars! Discover exclusive holiday pizza deals, Christmas party planning tips, festive menu ideas, family meal combos, and make your holiday celebration delicious and stress-free.',
    image: '/menu/Homepage-menus/Ultimate-Supreme-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Happy Christmas 2026 - Little Caesars Holiday Pizza Celebration with festive decorations',
  ...
  },
  {
    ...
    title: 'Little Caesars Secret Menu 2026 - Hidden Items & Ordering Hacks Revealed!',
    ...
    image: '/menu/Homepage-menus/ExtraMostBestest-Pepperoni-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Secret Menu 2026 - Hidden Items and Ordering Hacks',
  ...
  {
    id: 'pizza-ranking-2026',
    category: 'Best Pizza',
    title: 'Best Pizza at Little Caesars 2026 - All 12 Pizzas Ranked from #1 to Worst',
    ...
    image: '/menu/Homepage-menus/Classic-Pepperoni-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Best Pizza at Little Caesars - All Pizzas Ranked 2026',
    date: 'December 27, 2026',
    readTime: '10 min read',
  ...
  {
    id: 'delivery-guide-2026',
    category: 'Delivery Guide',
    title: 'Little Caesars Delivery 2026 - Complete Guide: Fees, Hours, Areas & Tips',
    ...
    image: '/menu/Homepage-menus/Ultimate-Supreme-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Delivery Guide 2026 - Fees, Hours, Tips',
    date: 'December 27, 2026',
    readTime: '7 min read',
  ...
  {
    id: 'los-angeles-location',
    category: 'City Locations',
    title: 'Little Caesars Los Angeles - 50+ Locations, Hours & Menu 2026',
    excerpt: 'Find Little Caesars in Los Angeles! 50+ locations across LA, menu prices, hours, delivery options, and deals. Serving Downtown LA, Hollywood, Santa Monica & more!',
    image: '/menu/Homepage-menus/Classic-Pepperoni-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Los Angeles Locations and Menu Guide',
    date: 'January 10, 2026',
    readTime: '5 min read',
    slug: 'little-caesars-los-angeles',
    isNew: true,
    featured: true
  },
  {
    id: 'chicago-location',
    category: 'City Locations',
    title: 'Little Caesars Chicago - 40+ Locations, Hours & Menu 2026',
    excerpt: 'Find Little Caesars in Chicago! 40+ locations across the Windy City, menu prices, hours, and delivery. Serving Downtown, North Side, South Side & all Chicagoland!',
    image: '/menu/Homepage-menus/Detroit-Style-Deep-Dish-Pepperoni-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Chicago Locations and Deep Dish Pizza',
    date: 'January 10, 2026',
    readTime: '5 min read',
    slug: 'little-caesars-chicago',
    isNew: true,
    featured: true
  },
  {
    id: 'houston-location',
    category: 'City Locations',
    title: 'Little Caesars Houston - 60+ Locations, Hours & Menu 2026',
    excerpt: 'Find Little Caesars in Houston! 60+ locations across H-Town, menu prices, hours, and Texas-sized deals. Serving all of Greater Houston Metro!',
    image: '/menu/Homepage-menus/ExtraMostBestest-Pepperoni-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Houston Texas Locations',
    date: 'January 10, 2026',
    readTime: '5 min read',
    slug: 'little-caesars-houston',
    isNew: true,
    featured: true
  },
  {
    id: 'phoenix-location',
    category: 'City Locations',
    title: 'Little Caesars Phoenix - 50+ Locations, Hours & Menu 2026',
    excerpt: 'Find Little Caesars in Phoenix! 50+ locations across the Valley of the Sun, menu prices, hours, and delivery. Serving Scottsdale, Tempe, Mesa & more!',
    image: '/menu/Homepage-menus/Ultimate-Supreme-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Phoenix Arizona Locations',
    date: 'January 10, 2026',
    readTime: '5 min read',
    slug: 'little-caesars-phoenix',
    isNew: true,
    featured: true
  },
  {
    id: 'philadelphia-location',
    category: 'City Locations',
    title: 'Little Caesars Philadelphia - 45+ Locations, Hours & Menu 2026',
    excerpt: 'Find Little Caesars in Philadelphia! 45+ locations across Philly, menu prices, hours, and Eagles Game Day deals. Serving all of the City of Brotherly Love!',
    image: '/menu/Homepage-menus/Classic-Pepperoni-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Philadelphia PA Locations',
    date: 'January 10, 2026',
    readTime: '5 min read',
    slug: 'little-caesars-philadelphia',
    isNew: true,
    featured: true
  },
  {
    id: 'san-diego-location',
    category: 'City Locations',
    title: 'Little Caesars San Diego - 35+ Locations, Hours & Menu 2026',
    excerpt: 'Find Little Caesars in San Diego! 35+ locations across America\'s Finest City, menu prices, hours, and beach delivery. Serving La Jolla, Pacific Beach & more!',
    image: '/menu/Homepage-menus/4-Cheese-Crazy-Puffs-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars San Diego California Locations',
    date: 'January 10, 2026',
    readTime: '5 min read',
    slug: 'little-caesars-san-diego',
    isNew: true,
    featured: true
  },
  {
    id: 'san-antonio-location',
    category: 'City Locations',
    title: 'Little Caesars San Antonio - 50+ Locations, Hours & Menu 2026',
    excerpt: 'Find Little Caesars in San Antonio! 50+ locations across the Alamo City, menu prices, hours, and Spurs Game Day specials. Serving all of Greater San Antonio!',
    image: '/menu/Homepage-menus/Stuffed-Crust-Pepperoni-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars San Antonio Texas Locations',
    date: 'January 10, 2026',
    readTime: '5 min read',
    slug: 'little-caesars-san-antonio',
    isNew: true,
    featured: true
  },
  {
    id: 'dallas-location',
    category: 'City Locations',
    title: 'Little Caesars Dallas - 70+ Locations, Hours & Menu 2026',
    excerpt: 'Find Little Caesars in Dallas! 70+ locations across Big D and DFW, menu prices, hours, and Cowboys Game Day deals. Serving all of Dallas-Fort Worth Metro!',
    image: '/menu/Homepage-menus/Detroit-Style-Deep-Dish-Cheese-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Dallas Texas DFW Locations',
    date: 'January 10, 2026',
    readTime: '5 min read',
    slug: 'little-caesars-dallas',
    isNew: true,
    featured: true
  },
  {
    id: 'detroit-location',
    category: 'City Locations',
    title: 'Little Caesars Detroit - Birthplace Since 1959! 50+ Locations 2026',
    excerpt: 'Little Caesars was FOUNDED in Detroit 1959! 50+ Motor City locations, menu prices, hours, and Lions Game Day specials. Visit where it all started!',
    image: '/menu/Homepage-menus/Detroit-Style-Deep-Dish-Pepperoni-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Detroit Michigan - Founded 1959',
    date: 'January 10, 2026',
    readTime: '6 min read',
    slug: 'little-caesars-detroit',
    isNew: true,
    featured: true
  },
  {
    id: 'miami-location',
    category: 'City Locations',
    title: 'Little Caesars Miami - 40+ Locations, Hours & Menu 2026',
    excerpt: 'Find Little Caesars in Miami! 40+ locations across the Magic City, menu prices, hours, Heat Game Day deals, and beach delivery. Serving all of Greater Miami!',
    image: '/menu/Homepage-menus/Ultimate-Supreme-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Miami Florida Locations',
    date: 'January 10, 2026',
    readTime: '5 min read',
    slug: 'little-caesars-miami',
    isNew: true,
    featured: true
  },
  {
    id: 'atlanta-location',
    category: 'City Locations',
    title: 'Little Caesars Atlanta - 45+ Locations, Hours & Menu 2026',
    excerpt: 'Find Little Caesars in Atlanta! 45+ locations across the ATL, menu prices, hours, and Falcons Game Day specials. Serving all of Metro Atlanta!',
    image: '/menu/Homepage-menus/ExtraMostBestest-Pepperoni-Pizza-Little-Caesars-Menu.webp',
    imageAlt: 'Little Caesars Atlanta Georgia Locations',
    date: 'January 11, 2026',
    readTime: '5 min read',
    slug: 'little-caesars-atlanta',
    isNew: true,
    featured: true
  }
]
