...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question", 
      "name": "Does Little Caesars have family meal deals?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, Little Caesars offers lunch combos and family-sized pizzas starting at $5.99. These include pizza slices, sides like Crazy Bread, and beverages perfect for sharing."
      }
    },
    {
      "@type": "Question",
      "name": "What are the most popular Little Caesars menu items?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Top menu items include Hot-N-Ready Pepperoni Pizza ($5.55), Crazy Bread 8-piece ($3.49), Detroit-Style Deep Dish Pepperoni ($8.49), and Caesar Wings ($8.49)."
      }
    },
    {
      "@type": "Question",
      "name": "Are Little Caesars menu calories listed?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, calorie information is available for all menu items. Pizza slices range from 220-380 calories, sides 25-180 calories, and beverages 140-250 calories."
      }
    }
  ]
}
