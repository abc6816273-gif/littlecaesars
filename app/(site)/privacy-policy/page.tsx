...
export const metadata: Metadata = {
  title: 'Privacy Policy | Little Caesars Menu Guide',
  description: 'Privacy policy for Little Caesars Menu Guide. Learn how we collect, use, and protect your personal information.',
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              ...
              See our <a href="/cookies-policy" className="text-little-caesars-orange hover:underline">Cookies Policy</a> for more details.
            </p>

            <h2>6. Third-Party Links</h2>
            <p>
              Our website may contain links to third-party websites, including the official Little Caesars website. 
            ...
            <ul>
              <li><strong>Email:</strong> privacy@littlecaesarsmenu.us</li>
            ...
            <div className="mt-12 p-6 bg-little-caesars-orange/10 rounded-lg border border-little-caesars-orange/20">
              <h3 className="text-stone-800 font-bold mb-2">Important Note</h3>
              <p className="text-stone-700 mb-0">
                This website is an independent menu information guide and is not affiliated with or endorsed by Little Caesars Enterprises, Inc. 
