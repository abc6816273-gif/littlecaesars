...
export const metadata: Metadata = {
  title: 'Terms and Conditions | Little Caesars Menu Guide',
  description: 'Terms and conditions for using Little Caesars Menu Guide. Read our terms of service and usage policies.',
  robots: {
    index: true,
    follow: true,
  },
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              By accessing and using Little Caesars Menu Guide ("the Website"), you accept and agree 
            ...
            <p>
              Little Caesars Menu Guide is an independent website that provides information about 
              Little Caesars menu items, prices, nutritional data, and promotional offers. 
              We are not affiliated with, endorsed by, or connected to Little Caesars Enterprises, Inc.
            </p>

            <h2>3. Use License</h2>
            <p>
              Permission is granted to temporarily download one copy of the materials on Little Caesars Menu Guide 
            ...
            <p>
              While we strive to provide accurate and up-to-date information about Little Caesars menu items, 
            ...
            <p>
              ...
              Please verify current prices and availability with your local Little Caesars restaurant.
            </p>
            ...
            <h2>5. Limitations</h2>
            <p>
              In no event shall Little Caesars Menu Guide or its suppliers be liable for any damages 
            ...
            <p>
              The materials appearing on Little Caesars Menu Guide could include technical, typographical, 
            ...
            <p>
              ...
              intellectual property laws. Little Caesars® is a registered trademark of Little Caesars Inc. 
              We do not claim any ownership of the Little Caesars trademark or brand.
            </p>

            <h2>12. Gift Card Services</h2>
            <p>
              Our gift card balance checker and related services are provided "as is" for convenience only. 
              For official gift card transactions and support, please visit the official Little Caesars website 
              or contact Little Caesars directly.
            </p>
            ...
            <ul>
              <li><strong>Email:</strong> legal@littlecaesarsmenu.us</li>
              <li><strong>Website:</strong> <a href="/contact" className="text-little-caesars-orange hover:underline">Contact Form</a></li>
            </ul>

            <div className="mt-12 p-6 bg-little-caesars-orange/10 rounded-lg border border-little-caesars-orange/20">
              <h3 className="text-stone-800 font-bold mb-2">Disclaimer</h3>
              <p className="text-stone-700 mb-0">
                This website is an independent menu information guide and is not affiliated with, 
                sponsored by, or endorsed by Little Caesars Enterprises, Inc. All trademarks, service marks, 
