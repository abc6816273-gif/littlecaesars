...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question", 
      "name": "Does Little Caesars offer family meal deals?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, Little Caesars offers family combos and lunch deals starting at $5.99. These include pizza slices, sides like Crazy Bread, and drinks. Perfect for families looking for quick, affordable meals."
      }
    },
    {
      "@type": "Question",
      "name": "What are the most popular Little Caesars menu items with calories?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Top menu items include: Hot-N-Ready Pepperoni Pizza ($5.55, 280 calories per slice), Crazy Bread 8-piece ($3.49, 100 calories per piece), Detroit-Style Deep Dish Pepperoni ($8.49, 320 calories per slice), and Caesar Wings ($8.49, 480 calories for 8 pieces)."
      }
    },
    {
      "@type": "Question",
      "name": "Where can I find Little Caesars nutrition and calorie information?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Complete nutrition facts are available for all menu items. Pizzas range 220-380 calories per slice, sides 25-180 calories, beverages 140-250 calories. Detailed macros, sodium, and allergen info available on our menu pages."
      }
    },
    {
      "@type": "Question",
