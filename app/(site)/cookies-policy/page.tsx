...
export const metadata: Metadata = {
  title: 'Cookies Policy | Little Caesars Menu Guide',
  description: 'Learn about how we use cookies and similar technologies on Little Caesars Menu Guide to improve your browsing experience.',
  robots: {
    index: true,
    follow: true,
  },
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              Little Caesars Menu Guide uses cookies to enhance your browsing experience and provide better services. 
            ...
            <ul>
              <li><strong>Google Analytics:</strong> <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-little-caesars-orange hover:underline">Google Analytics Opt-out Browser Add-on</a></li>
              <li><strong>Network Advertising:</strong> <a href="http://optout.networkadvertising.org/" target="_blank" rel="noopener noreferrer" className="text-little-caesars-orange hover:underline">NAI Opt-out Tool</a></li>
            </ul>
            ...
            <ul>
              <li><strong>Email:</strong> cookies@littlecaesarsmenu.us</li>
            ...
            <div className="mt-8 p-6 bg-little-caesars-orange/10 rounded-lg border border-little-caesars-orange/20">
              <h3 className="text-stone-800 font-bold mb-2">Related Policies</h3>
              <p className="text-stone-700 mb-2">
                For more information about how we handle your data, please review our related policies:
              </p>
              <ul className="mb-0">
                <li><a href="/privacy-policy" className="text-little-caesars-orange hover:underline">Privacy Policy</a></li>
                <li><a href="/terms-and-conditions" className="text-little-caesars-orange hover:underline">Terms and Conditions</a></li>
              </ul>
            </div>
          </div>
        </div>
