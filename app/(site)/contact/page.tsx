          ...
          <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-green/10 border border-green/20 rounded-lg p-8">
              ...
              <p className="text-stone/70 mb-6">
                ...
                If your inquiry is urgent, please consider visiting the official Little Caesars website.
              </p>
              ...
              <div className="space-y-6">
                <div className="bg-orange/10 border border-orange/20 rounded-lg p-6">
                  ...
                  <p className="text-stone/70 text-sm">
                    Please note that we are not affiliated with Little Caesars. 
                    For official restaurant inquiries, locations, online ordering, or complaints, 
                    please contact Little Caesars directly through their official website.
                  </p>
                </div>
                ...
                <div className="bg-little-caesars-orange/10 rounded-lg p-6">
                  <h3 className="font-slab font-slab-bold text-lg text-stone mb-3">
                    For Official Little Caesars Information
                  </h3>
                  <p className="text-stone/70 mb-4">
                    Please visit the official Little Caesars website for:
                  </p>
                  <ul className="space-y-1 text-stone/70 text-sm mb-4">
                    ...
                    <li>• Caesar Rewards loyalty program</li>
                  </ul>
                  <a
                    href="https://littlecaesars.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center text-little-caesars-orange hover:text-orange-600 transition-colors duration-200"
                  >
                    Visit littlecaesars.com
            ...
            <div className="relative bg-gradient-to-br from-white via-sand/5 to-orange/5 rounded-xl shadow-2xl border border-orange/20 overflow-hidden backdrop-blur-sm">
              ...
              <div className="relative bg-gradient-to-r from-orange-700 via-amber-600 to-orange-800 px-8 py-6 shadow-lg overflow-hidden">
                ...
                <div className="relative flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-slab font-slab-bold text-2xl text-white drop-shadow-sm">Pizza Pizza!</h3>
                    <p className="text-white/90 text-base font-medium">Drop us a line and share your feedback</p>
                  </div>
                </div>
              </div>
