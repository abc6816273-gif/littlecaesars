...
export const PERFORMANCE_CONFIG = {
  // Caching durations (in seconds) - OPTIMIZED FOR SPEED
  CACHE_DURATIONS: {
    HOMEPAGE: 1800,       // 30 minutes - Longer cache
    MENU_PAGES: 3600,     // 1 hour - Longer cache
    BLOG_POSTS: 3600,     // 1 hour - Much longer cache
    STATIC_PAGES: 7200,   // 2 hours - Extended cache
    API_CALLS: 1800,      // 30 minutes - Longer cache
  },
