...
export function generateOrganizationSchema() {
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Little Caesars Menu'
  ...
  return {
    ...
    description: 'Independent informational website about Little Caesars menu items, prices, and nutritional information',
    sameAs: [
      'https://www.littlecaesars.com', // Reference to official site
    ],
    contactPoint: {
      '@type': 'ContactPoint',
    ...
    disclaimer: 'This website is not affiliated with Little Caesars. All information is provided for reference purposes only.',
  }
}
...
export function generateRestaurantSchema() {
  return {
    ...
    '@type': 'Restaurant',
    name: 'Little Caesars',
    description: 'Pizza chain specializing in hot-n-ready pizzas and Italian-American cuisine',
    url: 'https://www.littlecaesars.com',
    servesCuisine: ['Pizza', 'Italian-American', 'Fast Food'],
    hasMenu: 'https://www.littlecaesars.com/menu',
    // Note: This is referencing the actual restaurant, not our site
    disclaimer: 'Information provided by independent third-party website. Not affiliated with Little Caesars.',
  }
}
